          ...
          children: [
            ...
            if (!widget.hasNotifications &&
              ...
              ListView.builder(
                  ...
                  itemCount:
                      _upcomingBookings.length + _pastBookings.length + 1,
                  itemBuilder: (context, index) {
                    ...
                    if (index > 0 && message != null) {
                      adjustedIndex = index -
                          (_isPushNotificationDismissed
                              ? 1
                              : 0); // Shift the index to account for push notification at 0
                    } else {
                      adjustedIndex = index;
                    }
                    ...
                    if (adjustedIndex < _upcomingBookings.length &&
                        adjustedIndex < notificationMessages.length) {
                      final isViewed =
                          viewedNotifications.contains(adjustedIndex);
                      ...
                      if (booking.bookingType == 'place') {
                        return NotificationCrd(
                          ...
                          onDismissed: () =>
                              _dismissNotification(adjustedIndex),
                          isViewed: isViewed,
                        );
