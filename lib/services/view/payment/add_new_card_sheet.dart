...
class GeneralAddNewCreditCard extends StatefulWidget {
  const GeneralAddNewCreditCard({
    Key? key,
    required this.total,
  ...
  @override
  State<GeneralAddNewCreditCard> createState() =>
      _GeneralAddNewCreditCardState();
}

class _GeneralAddNewCreditCardState extends State<GeneralAddNewCreditCard> {
                        ...
                        _paymentController.isCreditCardPaymentLoading.value
                            ...
                            : CustomButton(
                                onPressed: () async {
                                  ...
                                  final month =
                                      dateController.text.substring(0, 2);
                                  final year =
                                      dateController.text.substring(3, 5);
                                  if (int.parse(year) <
                                  ...
                                  var paymentResult = await widget
                                      .srvicesController
                                      .payWithCreditCard(
                                          context: context,
                                          amount: widget.total,
                                  ...
                                  if (paymentResult != null) {
                                    Navigator.push(
                                      ...
                                      final payment = await widget
                                          .srvicesController
                                          .hospitalityPayment(
                                              context: context,
                                              hospitalityId: paymentResult.id);
                                      print(payment!.payId);

                                      if (payment.payStatus != 'faild') {
