...
class CustomOnBoardingWidget extends StatelessWidget {
  ...
  const CustomOnBoardingWidget({Key? key,  required this.text, required this.description, required this.backgroundImage, this.nextScreen}) : super(key: key);
              ...
              child: Padding(
                ...
                child: Row(
                 ...
                 //   SizedBox(width:!AppUtil.rtlDirection(context)?  size.width *0.282:size.width * 0.07,),
                    InkWell(
                        onTap: nextScreen,
                        child: Icon(Icons.arrow_forward_outlined , color: Colors.white, size: size.width*0.0974,))
                  ],
                ),
              ),
            ),
