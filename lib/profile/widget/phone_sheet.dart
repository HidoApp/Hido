...
class _PhoneSheetState extends State<PhoneSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final hieht = MediaQuery.sizeOf(context).height;
              ...
              () => _profileController.isMobileOtpLoading.value
                  ...
                  : CustomButton(
                      ...
                      onPressed: () async {
                        ...
                        if (isValid) {
                          final isSuccess = await _profileController
                              .otpForMobile(context: context, mobile: mobile);
                              ...
                              onCompleted: (otpCode) async {
                                final user =
                                    await _profileController.updateMobile(
                                        ...
                                        otp: otpCode,
                                        mobile:
                                            _profileController.updatedMobile);
                                if (user != null) {
