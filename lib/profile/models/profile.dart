...
class Profile {
  ...
  factory Profile.fromJson(Map<String, dynamic> json) {
    return Profile(
      ...
      hostRating: json['hostRating']  != null ? (json['hostRating'] as num).toDouble() : 0.0,
      adventureNumber: json['adventureNumber'] ?? 0,
      adventureRating: json['adventureRating'] != null ? (json['adventureRating'] as num).toDouble() : 0.0,
      eventNumber: json['eventNumber'] ?? 0,
      eventRating: json['eventRating'] != null ? (json['eventRating'] as num).toDouble() : 0.0,
