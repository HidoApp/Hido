...
class _TripDetailsState extends State<TripDetails> {
  ...
  void initState() {
    ...
    //   ShowCaseWidget.of(myContext!)!.startShowCase([_key2]
    //   );});
  }
  ...
  void didChangeDependencies() {
    ...
    // Move the ShowCaseWidget starting logic here to ensure context is valid.
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final showcaseContext = ShowCaseWidget.of(myContext!);
      if (showcaseContext != null) {
        showcaseContext.startShowCase([_key2]);
      } else {
        // Handle the case where the context is not valid.
        print('ShowCaseWidget context is not available');
      }
    });
  }
              ...
              Padding(
                ...
                child: Obx(() => _RequestController.isBookingLoading.value ||
                    ...
                    : !AppUtil.isGuest() && isViewBooking.value
                        ...
                        : Showcase(
                            key: _key2,
                            description: 'Send your request to get personalized tour with local guides',
                            showArrow: true,
