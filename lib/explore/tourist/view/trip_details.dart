...
class _TripDetailsState extends State<TripDetails> {
  ...
  void getPlaceById() async {
    _touristExploreController.thePlace.value = await _touristExploreController
        .getPlaceById(id: widget.placeId!, context: context);
  }
  ...
  void initState() {
    ...
    if (!AppUtil.isGuest() && _profileController.profile.id != '') {
      ...
      _profileController.isTourBookmarked(_profileController.bookmarkList
          .any((bookmark) => bookmark.id == widget.placeId));
      // getPlaceBooking();
  ...
  void getOfferinfo() async {
    final place = await _touristExploreController.getPlaceById(
      id: widget.placeId,
      context: context,
    );

    if (place != null) {
      _touristExploreController.thePlace.value = place;
      ...
      // Handle the case where place is null if needed
                    ...
                    GestureDetector(
                      onTap: () {
                        Get.to(() => ViewTripImages(
                              tripImageUrl: _touristExploreController
                                  .thePlace.value!.image!,
                              fromNetwork:
                                  _touristExploreController.thePlace.value ==
                                          null
                                      ? false
                                      : true,
                            ));
                        ...
                        child: Column(
                          children: [
                            Align(
                                ...
                                child: CustomText(
                                  text: _touristExploreController
                                              .thePlace.value ==
                                          null
                                      ? 'tuwaik'.tr
                                      : AppUtil.rtlDirection2(context)
                                          ? _touristExploreController
                                              .thePlace.value!.nameAr!
                                          : _touristExploreController
                                              .thePlace.value!.nameEn!,
                              ...
                              children: [
                                ...
                                CustomText(
                                  text: _touristExploreController
                                          ...
                                          null
                                      ? AppUtil.rtlDirection2(context)
                                          ? "${_touristExploreController.thePlace.value!.regionAr!}, المملكة العربية السعودية"
                                          : "${_touristExploreController.thePlace.value!.regionEn!}, Saudi Arabia"
                                      : '',
                                  color: starGreyColor,
                                  fontSize: width * 0.03,
                            ...
                            ReadMoreWidget(
                              text: _touristExploreController.thePlace.value ==
                                      null
                                  ? "******"
                                  : AppUtil.rtlDirection2(context)
                                      ? _touristExploreController
                                          .thePlace.value!.descriptionAr!
                                      : _touristExploreController
                                          .thePlace.value!.descriptionEn!,
                            ),
                            SizedBox(
                              height: width * 0.026,
                            ),
                    ...
                    child: Row(
                      children: [
                            ...
                            onTap: () {
                              ...
                              if (_profileController.isTourBookmarked.value) {
                                final bookmark = Bookmark(
                                    ...
                                    id: _touristExploreController
                                        .thePlace.value!.id!,
                                    titleEn: _touristExploreController
                                            .thePlace.value!.nameEn ??
                                        "",
                                    titleAr: _touristExploreController
                                            .thePlace.value!.nameAr ??
                                        "",
                                    image: _touristExploreController
                                        .thePlace.value!.image!.first,
                                    type: 'tour');
                        ...
                        if (_touristExploreController.thePlace.value != null)
                          ShareWidget(
                            id: _touristExploreController.thePlace.value!.id!,
                            type: 'place',
                            title: _touristExploreController
                                .thePlace.value!.nameEn,
                            description: _touristExploreController
                                .thePlace.value!.descriptionEn,
                            image: _touristExploreController
                                .thePlace.value!.image![0],
                            validTo: "",
                          )
                      ],
                    ),
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: AnimatedSmoothIndicator(
                        ...
                        count: _touristExploreController
                                    .thePlace.value!.image!.length >=
                                6
                            ? 6
                            : _touristExploreController
