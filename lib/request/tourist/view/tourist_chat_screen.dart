...
class _TouristChatScreenState extends State<TouristChatScreen> {
  ...
  Future<void> showBottomSheet(double width, double height,Function(bool) updateIconDisabled) async {
                      ...
                      CustomButton(
                        onPressed: () {
                          setState(() {
                            isSendTapped = false;
                            isStarChecked = false;
                            updateIconDisabled(true); // Update the state of the parent widget
